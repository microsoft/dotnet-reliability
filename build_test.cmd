...
call msbuild test/genstress.proj /verbosity:%msbuildverbosity% /maxcpucount /p:BuildInParallel=true /p:CloudDropAccessToken=%1 /p:CloudResultsAccessToken=%2 /p:BuildCompleteConnection=%3 /p:HelixApiAccessKey=%4 /p:FilterToTestTFM=netcoreapp1.0
