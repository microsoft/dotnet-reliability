...
then
  ...
  then
    ...
    echo "executing dumpling upload --dumppath $_corefile --noprompt --triage full --displayname $STRESS_TESTID --incpaths $HELIX_WORKITEM_ROOT/execution --properties STRESS_BUILDID=$STRESS_BUILDID STRESS_TESTID=$STRESS_TESTID"
    dumpling upload --dumppath $_corefile --noprompt --triage full --displayname $STRESS_TESTID --incpaths $HELIX_WORKITEM_ROOT/execution --properties STRESS_BUILDID=$STRESS_BUILDID STRESS_TESTID=$STRESS_TESTID
  else
